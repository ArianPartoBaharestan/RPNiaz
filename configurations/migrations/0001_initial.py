    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_icon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fac_icon', to='utils.images')),
                ('nav_icon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='van_icon', to='utils.images')),
            ],
            options={
                'abstract': False,
            },
